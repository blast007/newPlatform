...
public:
    ...
    void setKeyCallback(std::function<void(BzfPlatform*, BzfWindow*, BzfKey key, BzfKeyAction action, int mods)> callback);
    ...
    void setTextCallback(std::function<void(BzfPlatform*, BzfWindow*, char text[32])> callback);
    ...
    void setCursorPosCallback(std::function<void(BzfPlatform*, BzfWindow*, double x, double y)> callback);
    ...
    void setScrollCallback(std::function<void(BzfPlatform*,BzfWindow*, double x, double y)> callback);
    ...
    void setJoystickHatCallback(std::function<void(BzfPlatform*, BzfWindow*, BzfJoyHat hat, BzfJoyHatDirection direction)>
                                callback);
...
protected:
    ...
    std::function<void(BzfPlatform*,BzfWindow*,BzfKey,BzfKeyAction,int)> keyCallback;
    std::function<void(BzfPlatform*,BzfWindow*,char[32])> textCallback;
    std::function<void(BzfPlatform*,BzfWindow*,double,double)> cursorPosCallback;
    std::function<void(BzfPlatform*,BzfWindow*,BzfMouseButton,BzfButtonAction,int)> mouseButtonCallback;
    std::function<void(BzfPlatform*,BzfWindow*,double,double)> scrollCallback;
    std::function<void(BzfPlatform*,BzfWindow*,BzfJoyButton,BzfButtonAction)> joystickButtonCallback;
    std::function<void(BzfPlatform*,BzfWindow*,BzfJoyHat,BzfJoyHatDirection)> joystickHatCallback;
};
